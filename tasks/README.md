...
(closer log in task 10's QA.md). **v1.1 progress: 12 ☑, 13 ☑, 15 ☑
(Clark expansion + Hull Integrity recomposition, same-day Joe spec) —
remaining: 14 (incoming-flow row), then v1.1.0 tag = Joe's call.**
...
| 14 | v1.1 — Incoming-flow row: socket-only vB/s on the mempool panel (the honest stat task 05 dropped, source found in 09) | 10 | ☐ v1.1 — NEXT |
