...
**v1 PROJECT DONE (2026-07-17)** — every v1 task ☑, `v1.0.0` tagged, Pages
live, custom domain wired. Sole remaining hand: Joe's registrar DNS flip,
then the two post-DNS closers recorded in task 10's row and QA.md.
